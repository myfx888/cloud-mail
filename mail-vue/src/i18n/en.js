const en = {
    ...
    noContent: 'This email has no body content',
    ...
    smtpConnectSuccess: 'SMTP connection successful',
    smtpConnectFailed: 'SMTP connection failed',
    smtpConfigIncomplete: 'SMTP configuration incomplete',
    emailAccounts: 'Email Accounts',
    smtpOverride: 'Override SMTP Settings',
    ...
    aiEnable: 'Enable AI',
    aiProviderLabel: 'API Type',
    aiProviderOpenai: 'OpenAI Compatible',
    aiProviderAnthropic: 'Anthropic',
    aiProviderDesc: 'OpenAI compatible supports OpenAI, DeepSeek, Moonshot, Qwen, etc. Anthropic supports Claude models.',
    aiBaseUrl: 'API Base URL',
    aiApiKey: 'API Key',
    aiModel: 'Model',
    aiSystemPrompt: 'System Prompt',
    aiSystemPromptPlaceholder: 'Custom system prompt (optional)',
    aiTestConnection: 'Test Connection',
    aiTestSuccess: 'AI Connected! Model: {model}',
    aiTestFailed: 'AI Connection failed: {msg}',
    aiInputPlaceholder: 'Ask your email assistant...',
    aiIntro: "I'm your email assistant. I can read, search, draft, and manage your emails.",
    aiSuggestLatest: 'Show my latest emails',
    aiSuggestUnread: 'Find unread emails',
    aiSuggestDraft: 'Draft a new email',
    aiToolListEmails: 'List Emails',
    aiToolGetEmail: 'Read Email',
    aiToolGetThread: 'Get Thread',
    aiToolSearch: 'Search',
    aiToolDraftReply: 'Draft Reply',
    aiToolDraftEmail: 'Draft Email',
    aiToolMarkRead: 'Mark Read',
