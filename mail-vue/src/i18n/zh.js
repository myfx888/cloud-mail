const zh = {
    ...
    smtpConnectSuccess: 'SMTP 连接成功',
    smtpConnectFailed: 'SMTP 连接失败',
    smtpConfigIncomplete: 'SMTP 配置不完整',
    emailAccounts: '邮件账户',
    smtpOverride: '覆盖 SMTP 设置',
    ...
    aiSetting: 'AI 设置',
    aiEnable: '启用 AI',
    aiProviderLabel: 'API 类型',
    aiProviderOpenai: 'OpenAI 兼容',
    aiProviderAnthropic: 'Anthropic',
    aiProviderDesc: 'OpenAI 兼容格式支持 OpenAI、DeepSeek、Moonshot、通义千问等；Anthropic 格式支持 Claude 系列',
    aiBaseUrl: 'API 地址',
    aiApiKey: 'API 密钥',
    aiModel: '模型名称',
    aiSystemPrompt: '系统提示词',
    aiSystemPromptPlaceholder: '自定义系统提示词（可选）',
    aiTestConnection: '测试连接',
    aiTestSuccess: 'AI 连接成功！模型：{model}',
    aiTestFailed: 'AI 连接失败：{msg}',
    aiInputPlaceholder: '问问你的邮件助手...',
    aiIntro: '我是你的邮件助手，可以帮你阅读、搜索、起草和管理邮件。',
    aiSuggestLatest: '查看最新邮件',
    aiSuggestUnread: '查找未读邮件',
    aiSuggestDraft: '起草一封邮件',
    aiToolListEmails: '获取邮件列表',
    aiToolGetEmail: '读取邮件',
    aiToolGetThread: '获取会话',
    aiToolSearch: '搜索邮件',
    aiToolDraftReply: '起草回复',
    aiToolDraftEmail: '起草邮件',
    aiToolMarkRead: '标记已读',
